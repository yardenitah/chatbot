...
public class AmazonService {
    ...
    public static final Pattern PRODUCT_PATTERN = Pattern.compile("\"<span class=\\\"a-size-medium a-color-base a-text-normal\\\">([^<]+)<\\/span>.*<span class=\\\"a-icon-alt\\\">([^<]+)<\\/span>.*<span class=\\\"a-color-base\\\">([^<]+)<\\/span>\"gm");
